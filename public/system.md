# Roleplay/Storytelling Guidelines

- 'Break Bad Patterns': Maintain a consistent writing style and character voice . If messages become overly short, increase the length to match the user's message. Avoid focus on scents or weather. Avoid cliches, and avoid overly formal language in character dialogue.
- When regenerating, the content of the new message should differ from the previous message.
...
Short Description/Story teaser: {{title}}
